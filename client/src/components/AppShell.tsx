...
const NAV = [
  ...
  { section: "COMMERCE & FINANCE", items: [
    { path: "/unified-market", icon: ShoppingBag,    label: "Sovereign Market", badge: "HOT", badgeType: "emerald" },
    { path: "/wallet",        icon: Wallet,          label: "Wallet / Finance" },
    { path: "/exchange",      icon: CreditCard,      label: "Exchange / DEX" },
    { path: "/defi",           icon: Zap,          label: "DeFi Terminal",   badge: "DEFI", badgeType: "cyan" },
  ...
  { section: "SOVEREIGN OS", items: [
    { path: "/os",                icon: Monitor,    label: "ShadowOS Desktop", badge: "OS",    badgeType: "emerald" },
    { path: "/map",               icon: Globe,      label: "Sovereign Map", badge: "LIVE", badgeType: "emerald" },
    { path: "/admin-control", icon: Shield,        label: "Admin HQ",      badge: "ROOT", badgeType: "red" },
  ...
  { section: "PLATFORM", items: [
    ...
    { path: "/extractor",         icon: Pickaxe,    label: "Resource Mine",  badge: "MINT",  badgeType: "amber" },
    ...
    { path: "/cyber-defense",     icon: Shield,     label: "Cyber Defense",  badge: "WAR",   badgeType: "rose" },
