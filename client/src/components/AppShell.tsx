...
const NAV = [
  ...
  { section: "PLATFORM", items: [
    ...
    { path: "/neural-market",     icon: ShoppingBag,label: "Neural Market",  badge: "P2P",  badgeType: "emerald" },
    { path: "/intel-agency",      icon: Eye,        label: "Intel Agency",   badge: "SHADOW",badgeType: "rose" },
    { path: "/feature-factory",   icon: Cpu,        label: "Feature Factory",badge: "BUILD", badgeType: "cyan" },
    { path: "/identity-vault",    icon: UserCheck,  label: "Identity Vault", badge: "ID",    badgeType: "emerald" },
