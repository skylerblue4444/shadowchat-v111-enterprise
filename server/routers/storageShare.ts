/**
 * Storage Share Router — Available spaces, booking, insurance, access, reviews
...
export const storageShareRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "storageShare", version: "3.0.0",
