/**
 * Parking Share Router — List spaces, booking, pricing, access control, revenue
...
export const parkingShareRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "parkingShare", version: "3.0.0",
