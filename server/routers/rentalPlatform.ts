/**
 * Rental Platform Router — Equipment, vehicles, spaces, peer-to-peer, insurance, damage claims
...
export const rentalPlatformRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "rentalPlatform", version: "3.0.0",
