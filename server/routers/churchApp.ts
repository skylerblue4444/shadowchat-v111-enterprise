/**
 * Community Groups Router — Events, donations, groups, messaging, streaming, volunteering
...
export const churchAppRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "churchApp", version: "3.0.0",
