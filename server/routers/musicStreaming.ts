/**
 * Music Streaming Router — Library, playlists, radio, lyrics, social, offline, hi-fi
...
export const musicStreamingRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "musicStreaming", version: "3.0.0",
