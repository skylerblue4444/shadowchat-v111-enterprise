/**
 * Tool Library Router — Borrowing, availability, condition, deposits, community
...
export const toolLibraryRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "toolLibrary", version: "3.0.0",
