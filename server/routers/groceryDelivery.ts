/**
 * Grocery Delivery Router — Fresh produce, same-day delivery, subscription boxes, meal kits
...
export const groceryDeliveryRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "groceryDelivery", version: "3.0.0",
