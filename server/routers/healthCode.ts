/**
 * Health Code Router — Digital health pass, vaccination records, test results, travel history
...
export const healthCodeRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "healthCode", version: "3.0.0",
