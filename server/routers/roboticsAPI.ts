/**
 * Robotics API Router — ROS integration, path planning, sensor fusion, teleoperation, fleet management
 * ShadowChat Enterprise Platform v110
 */
import { protectedProcedure, router } from "../_core/trpc";
import { z } from "zod";

export const roboticsAPIRouter = router({
