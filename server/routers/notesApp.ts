/**
 * Notes App Router — Rich text, markdown, tags, notebooks, search, sync, collaboration
...
export const notesAppRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "notesApp", version: "3.0.0",
