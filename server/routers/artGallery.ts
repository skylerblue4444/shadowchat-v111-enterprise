/**
 * Art Gallery Router — Collections, exhibitions, artists, purchases, AR preview
...
export const artGalleryRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "artGallery", version: "3.0.0",
