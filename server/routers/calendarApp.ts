/**
 * Calendar App Router — Events, scheduling, availability, integrations, reminders, sharing
...
export const calendarAppRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "calendarApp", version: "3.0.0",
