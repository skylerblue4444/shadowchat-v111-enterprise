/**
 * Will & Estate Router — Will creation, beneficiaries, digital assets, executor tools
...
export const willEstateRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "willEstate", version: "3.0.0",
