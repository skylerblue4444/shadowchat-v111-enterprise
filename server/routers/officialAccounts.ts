/**
 * Official Accounts Router — Business accounts, content publishing, follower management, analytics, CRM
...
export const officialAccountsRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "officialAccounts", version: "3.0.0",
