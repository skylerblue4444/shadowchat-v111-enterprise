/**
 * Food Ordering Router — Restaurant discovery, menu, ordering, delivery tracking, reviews, loyalty
...
export const foodOrderingRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "foodOrdering", version: "3.0.0",
