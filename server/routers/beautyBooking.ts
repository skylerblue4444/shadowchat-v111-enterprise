/**
 * Beauty Booking Router — Salons, spas, treatments, stylists, reviews, loyalty
...
export const beautyBookingRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "beautyBooking", version: "3.0.0",
