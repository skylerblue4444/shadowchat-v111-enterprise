/**
 * Mini App Engine Router — WeChat-style mini programs, sandboxed execution, lifecycle management, permissions, analytics, app store
...
export const miniAppEngineRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "miniAppEngine", version: "3.0.0",
