/**
 * Meal Sharing Router — Home cooks, menus, ordering, delivery, reviews, dietary
...
export const mealSharingRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "mealSharing", version: "3.0.0",
