/**
 * Freelance Market Router — Gig posting, bidding, milestones, escrow, reviews, disputes
...
export const freelanceMarketRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "freelanceMarket", version: "3.0.0",
