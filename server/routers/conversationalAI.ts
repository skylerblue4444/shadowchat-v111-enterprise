/**
 * Conversational AI Router — Dialog management, NLU, intent detection, entity extraction, handoff, training
 * ShadowChat Enterprise Platform v110
 */
import { protectedProcedure, router } from "../_core/trpc";
import { z } from "zod";

export const conversationalAIRouter = router({
