/**
 * Garden Planner Router — Plant database, scheduling, reminders, weather, community
...
export const gardenPlannerRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "gardenPlanner", version: "3.0.0",
