/**
 * Merchant Services Router — POS, inventory, staff, analytics, loyalty, multi-location
...
export const merchantServicesRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "merchantServices", version: "3.0.0",
