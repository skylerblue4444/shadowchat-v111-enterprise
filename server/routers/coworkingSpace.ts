/**
 * Coworking Space Router — Booking, hot desks, meeting rooms, community, events, billing
...
export const coworkingSpaceRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "coworkingSpace", version: "3.0.0",
