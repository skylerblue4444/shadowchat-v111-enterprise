/**
 * Parking Finder Router — Availability, booking, payment, navigation, EV charging
...
export const parkingFinderRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "parkingFinder", version: "3.0.0",
