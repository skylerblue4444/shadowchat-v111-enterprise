/**
 * Craft Market Router — Handmade goods, custom orders, workshops, materials, community
...
export const craftMarketRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "craftMarket", version: "3.0.0",
