/**
 * Meditation App Router — Guided sessions, breathing, sleep stories, streaks, community
...
export const meditationAppRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "meditationApp", version: "3.0.0",
