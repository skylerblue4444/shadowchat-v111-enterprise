/**
 * Translator Engine Router — Text, voice, camera, conversation mode, offline, 100+ languages
...
export const translatorEngineRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "translatorEngine", version: "3.0.0",
