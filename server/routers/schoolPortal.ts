/**
 * School Portal Router — Grades, attendance, homework, communication, calendar, fees
...
export const schoolPortalRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "schoolPortal", version: "3.0.0",
