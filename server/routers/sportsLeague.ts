/**
 * Sports League Router — Teams, schedules, scores, stats, brackets, registration
...
export const sportsLeagueRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "sportsLeague", version: "3.0.0",
