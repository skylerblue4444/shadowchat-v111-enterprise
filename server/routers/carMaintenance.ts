/**
 * Car Maintenance Router — Service history, reminders, mechanics, parts, recalls, OBD2
...
export const carMaintenanceRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "carMaintenance", version: "3.0.0",
