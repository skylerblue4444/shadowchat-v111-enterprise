/**
 * Legal & Compliance Router — Contract analysis, GDPR automation, e-discovery, clause library, regulatory tracking
 * ShadowChat Enterprise Platform v110
 */
import { protectedProcedure, router } from "../_core/trpc";
import { z } from "zod";

export const legalComplianceRouter = router({
