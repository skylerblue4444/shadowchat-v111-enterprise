/**
 * Channels & Live Router — Short video, live streaming, e-commerce live, virtual gifts, creator tools
...
export const channelsLiveRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "channelsLive", version: "3.0.0",
