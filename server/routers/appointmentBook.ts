/**
 * Appointment Booking Router — Service providers, availability, reminders, waitlist, group booking
...
export const appointmentBookRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "appointmentBook", version: "3.0.0",
