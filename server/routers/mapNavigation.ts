/**
 * Map & Navigation Router — Routing, traffic, transit, walking, cycling, indoor maps, AR nav
...
export const mapNavigationRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "mapNavigation", version: "3.0.0",
