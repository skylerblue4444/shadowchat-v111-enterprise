/**
 * Social Commerce v2 Router — Group buying, flash sales, live commerce, affiliate, dropshipping
...
export const socialCommerceRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "socialCommerce", version: "3.0.0",
