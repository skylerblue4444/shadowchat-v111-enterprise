/**
 * Money Transfer Router — P2P, international, business, scheduled, recurring, split bills
...
export const moneyTransferRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "moneyTransfer", version: "3.0.0",
