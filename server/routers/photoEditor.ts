/**
 * Photo Editor Router — Filters, adjustments, collage, stickers, AI enhance, sharing
...
export const photoEditorRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "photoEditor", version: "3.0.0",
