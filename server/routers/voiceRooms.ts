/**
 * Voice Rooms Router — Clubhouse-style, moderation, recording, scheduling, monetization
...
export const voiceRoomsRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "voiceRooms", version: "3.0.0",
