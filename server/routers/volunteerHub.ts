/**
 * Volunteer Hub Router — Opportunities, matching, hours tracking, certificates, impact
...
export const volunteerHubRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "volunteerHub", version: "3.0.0",
