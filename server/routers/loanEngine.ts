/**
 * Loan Engine Router — Applications, underwriting, disbursement, repayment, collections, refinancing
...
export const loanEngineRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "loanEngine", version: "3.0.0",
