/**
 * Skill Swap Router — Offerings, requests, matching, scheduling, reviews, credits
...
export const skillSwapRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "skillSwap", version: "3.0.0",
