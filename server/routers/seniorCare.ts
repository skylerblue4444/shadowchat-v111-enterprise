/**
 * Senior Care Router — Medication, appointments, emergency, activity, family updates
...
export const seniorCareRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "seniorCare", version: "3.0.0",
