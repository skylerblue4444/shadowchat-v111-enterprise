/**
 * Property Platform Router — Listings, virtual tours, smart contracts, tenant portal, maintenance tracking
 * ShadowChat Enterprise Platform v110
 */
import { protectedProcedure, router } from "../_core/trpc";
import { z } from "zod";

export const propTechRouter = router({
