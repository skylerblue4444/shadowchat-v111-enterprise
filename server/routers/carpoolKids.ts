/**
 * Carpool Kids Router — School routes, scheduling, trusted drivers, tracking, payments
...
export const carpoolKidsRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "carpoolKids", version: "3.0.0",
