/**
 * Podcast Engine Router — Discovery, playback, subscriptions, downloads, chapters, transcripts
...
export const podcastEngineRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "podcastEngine", version: "3.0.0",
