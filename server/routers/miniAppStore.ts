/**
 * Mini App Store Router — Discovery, ratings, reviews, categories, featured apps, developer portal, monetization
...
export const miniAppStoreRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "miniAppStore", version: "3.0.0",
