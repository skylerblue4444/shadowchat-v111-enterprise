/**
 * Video Shorts Router — TikTok-style, editing, effects, duets, trends, monetization
...
export const videoShortsRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "videoShorts", version: "3.0.0",
