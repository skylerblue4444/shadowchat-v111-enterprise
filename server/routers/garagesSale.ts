/**
 * Garage Sale Router — Listings, location, messaging, offers, pickup scheduling
...
export const garagesSaleRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "garagesSale", version: "3.0.0",
