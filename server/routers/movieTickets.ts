/**
 * Movie Tickets Router — Showtimes, seat selection, booking, reviews, rewards, group bookings
...
export const movieTicketsRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "movieTickets", version: "3.0.0",
