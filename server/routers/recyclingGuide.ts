/**
 * Recycling Guide Router — Scanner, locations, rewards, impact tracking, community
...
export const recyclingGuideRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "recyclingGuide", version: "3.0.0",
