/**
 * Health Platform Router — EHR integration, FHIR API, telehealth, wearable sync, clinical workflows
 * ShadowChat Enterprise Platform v110
 */
import { protectedProcedure, router } from "../_core/trpc";
import { z } from "zod";

export const healthPlatformRouter = router({
