/**
 * Mini App Payments Router — In-app purchases, subscriptions, revenue sharing, settlements, refunds
...
export const miniAppPaymentsRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "miniAppPayments", version: "3.0.0",
