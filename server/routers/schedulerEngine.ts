/**
 * Scheduler Engine Router — Cron jobs, one-time tasks, distributed locking, retry, monitoring, dependencies
 * ShadowChat Enterprise Platform v110
 */
import { protectedProcedure, router } from "../_core/trpc";
import { z } from "zod";

export const schedulerEngineRouter = router({
