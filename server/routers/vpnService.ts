/**
 * VPN Service Router — Servers, protocols, kill switch, split tunneling, speed test
...
export const vpnServiceRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "vpnService", version: "3.0.0",
