/**
 * Pet Services Router — Vet booking, pet sitting, grooming, supplies, insurance, social
...
export const petServicesRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "petServices", version: "3.0.0",
