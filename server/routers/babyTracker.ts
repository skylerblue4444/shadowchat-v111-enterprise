/**
 * Baby Tracker Router — Feeding, sleep, growth, milestones, photos, family sharing
...
export const babyTrackerRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "babyTracker", version: "3.0.0",
