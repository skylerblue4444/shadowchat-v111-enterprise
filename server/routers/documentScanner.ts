/**
 * Document Scanner Router — Camera capture, OCR, PDF export, cloud storage, organization
...
export const documentScannerRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "documentScanner", version: "3.0.0",
