/**
 * Recipe App Router — Discovery, collections, meal planning, shopping lists, nutrition
...
export const recipeAppRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "recipeApp", version: "3.0.0",
