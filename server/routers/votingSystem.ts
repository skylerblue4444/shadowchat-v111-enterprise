/**
 * Voting System Router — Polls, elections, ranked choice, delegation, verification, results
...
export const votingSystemRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "votingSystem", version: "3.0.0",
