/**
 * Emergency Alert Router — SOS, contacts, location sharing, first aid, disaster info
...
export const emergencyAlertRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "emergencyAlert", version: "3.0.0",
