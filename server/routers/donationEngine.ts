/**
 * Donation Engine Router — Campaigns, recurring, matching, tax receipts, impact reporting
...
export const donationEngineRouter = router({
  // Core CRUD
  ...
  health: protectedProcedure.query(async () => ({
    status: "healthy", module: "donationEngine", version: "3.0.0",
